...
describe("Packed histogram", function () {
    it("should compute median value in first bucket", function () {
        // given
        var histogram = new PackedHistogram_1.default(1, Number.MAX_SAFE_INTEGER, 3);
    ...
    it("should resize underlying packed array when recording an out of bound value", function () {
        // given
        var histogram = new PackedHistogram_1.default(1, 2, 3);
        histogram.autoResize = true;
        // when
        histogram.recordValue(123456);
        // then
        chai_1.expect(histogram.totalCount).to.equal(1);
    });
});
