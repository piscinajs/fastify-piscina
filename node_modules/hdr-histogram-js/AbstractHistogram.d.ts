...
export interface HistogramConstructor {
    new (lowestDiscernibleValue: number, highestTrackableValue: number, numberOfSignificantValueDigits: number): AbstractHistogram;
}
export declare abstract class AbstractHistogram extends AbstractHistogramBase {
    /**
    ...
    private resetMinNonZeroValue;
    constructor(lowestDiscernibleValue: number, highestTrackableValue: number, numberOfSignificantValueDigits: number);
    init(lowestDiscernibleValue: number, highestTrackableValue: number, numberOfSignificantValueDigits: number, integerToDoubleValueConversionRatio: number, normalizingIndexOffset: number): void;
    /**
     ...
     */
    addWhileCorrectingForCoordinatedOmission(otherHistogram: AbstractHistogram, expectedIntervalBetweenValueSamples: number): void;
    /**
     ...
     */
    add(otherHistogram: AbstractHistogram): void;
    /**
     ...
     *
     */
    subtract(otherHistogram: AbstractHistogram): void;
